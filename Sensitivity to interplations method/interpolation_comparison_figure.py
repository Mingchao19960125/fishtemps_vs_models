...
ax1.plot(comparison_df.index,comparison_df['fitting'].values,color='blue',alpha=0.8,linewidth=0.6,label='Bilinear Interpolation')
...
ax2.plot(comparison_df.index,comparison_df['no_fitting'].values,color='green',alpha=0.8,linewidth=0.6,label='Nearest Interpolation')
...
ax3.text(0.8,20, 'CC:%.2f'%corrcoef(fitting_list,observation_list), color='r', fontsize=12)
ax4.text(0.8,20, 'CC:%.2f'%corrcoef(nofitting_list,observation_list), color='r', fontsize=12)
